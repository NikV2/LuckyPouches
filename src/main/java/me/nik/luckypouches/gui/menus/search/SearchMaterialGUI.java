package me.nik.luckypouches.gui.menus.search;
...
public class SearchMaterialGUI extends PaginatedMenu {

    private final String searchedValue;

    public SearchMaterialGUI(PlayerMenu playerMenu, LuckyPouches plugin, String searchedValue) {
    ...
    protected void setMenuItems() {
        ...
        List<ItemStack> materials = Arrays.stream(Material.values())
                .filter(material -> material.name().toLowerCase().contains(this.searchedValue))
                .map(ItemStack::new)
